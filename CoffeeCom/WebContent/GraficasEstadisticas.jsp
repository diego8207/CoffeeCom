<div class="row">
								<div class="col-md-6 col-sm-6">
									...
									<div class="portlet solid bordered light-grey">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-bar-chart-o"></i>Produccion de la asociación por Libras  
											</div>
											<div class="tools">
												<div class="btn-group" data-toggle="buttons">
													<label class="btn default btn-sm active">
													<input type="radio" name="options" class="toggle" id="option1">Caficultores</label>
													<label class="btn default btn-sm">
													<input type="radio" name="options" class="toggle" id="option2">Tipo Cafe</label>
												</div>
											</div>
										</div>
								...
								<div class="col-md-6 col-sm-6">
									...
									<div class="portlet solid light-grey bordered">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-bullhorn"></i>Produccion Junio 2016
											</div>
											<div class="tools">
									...
									<div class="portlet solid bordered light-grey">
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-signal"></i>Comercialización Bolsa New York
											</div>
											<div class="tools">
												<div class="btn-group pull-right" data-toggle="buttons">
